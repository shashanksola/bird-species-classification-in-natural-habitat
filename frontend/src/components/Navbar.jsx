...
const Navbar = () => {
    ...
    return <>
        <nav className="fixed top-0 left-0 flex justify-around items-center p-4 bg-trasparent backdrop-blur-3xl w-screen">
            ...
            <div className="flex flex-row justify-around w-4/6 items-center">
                <Link href="/" className="text-slate-200 text-4xl flex items-center" style={{ fontFamily: "sans-serif", fontWeight: '700' }}><i className="max-md:hidden">Birdz</i><img src="/src/assets/logo.png" alt="Birdz" width={'100px'} /></Link>
                {pages.map((page) => {
                    return (
