                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        {pages.map((page) => {
                            return (<li className="nav-item">
                                <Link className="nav-link active" aria-current="page" to={'/' + page}>{page}</Link>
                            </li>)
                        })}
                    </ul>
                    <form className="d-flex" role="search">
                        <input className="form-control me-2" type="search" placeholder="Find your favourite birdie here!" aria-label="Search" />
