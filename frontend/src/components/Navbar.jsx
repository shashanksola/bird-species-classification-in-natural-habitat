...
const scrollToFindABird = () => {
    document.getElementById("findabird").scrollIntoView({ behavior: 'smooth' })
}

const scrollToClassifyABird = () => {
...
const Navbar = () => {
    ...
    return <>
        <nav className="fixed top-0 left-0 flex justify-around items-center p-4 bg-orange-100 backdrop-blur-3xl w-screen z-30 shadow-lg" id="nav">
            ...
            <div className="flex flex-row justify-around w-screen items-center text-orange-900 font-semibold text-xl">
                ...
                <a onClick={() => scrollToClassifyABird()}>Classify a Bird</a>
