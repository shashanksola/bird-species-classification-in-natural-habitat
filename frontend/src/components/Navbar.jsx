...
const Navbar = () => {
  ...
  return (
    <nav
      id="nav"
      className="fixed top-0 left-0 w-screen z-30 h-20 p-4 bg-white/80 backdrop-blur-3xl shadow-sm transition-all"
    >
      <div className="flex flex-row justify-around items-center w-full px-6 py-4 text-slate-800 font-medium text-lg">
        ...
        <a onClick={scrollToBottom} className="hover:cursor-pointer hover:text-blue-600 transition-colors duration-200">
          {t('navbar.aboutUs')}
        </a>
      </div>
    </nav>
