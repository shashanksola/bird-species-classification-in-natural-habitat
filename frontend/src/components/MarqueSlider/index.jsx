...
const MarqueSlider = () => {
    return <>
        ...
        <div className="wrapper">
            <div className="itemLeft item1 bg-[url('/src/assets/b4.jpg')] bg-cover bg-center"></div>
            <div className="itemLeft item2 bg-[url('/src/assets/b5.jpg')] bg-cover bg-center"></div>
            <div className="itemLeft item3 bg-[url('/src/assets/b6.jpg')] bg-cover bg-center"></div>
        </div>
    </>
}
