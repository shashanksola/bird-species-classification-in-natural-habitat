...
const Home = () => {
    ...
    return (
        <>
            ...
            <Navbar />
                <section className="h-[100vh] bg-cover bg-center flex flex-col p-40 max-lg:p-8 max-lg:pt-36 bg-gradient-to-b from-blue-50 to-slate-100" style={{ marginTop: '-10px' }}>
                    <h1 className="text-nowrap max-md:mt-20 text-6xl md:text-9xl font-sans font-extrabold text-blue-600 animate-slidein600">Find Your <br></br> <i className="text-slate-800">Bird</i></h1>
                    <button onClick={scrollToFindABird} className="animate-slidein900 max-md:w-1/2 mt-8 border p-4 border-blue-600 hover:bg-blue-600 hover:text-white rounded-md bg-transparent text-slate-800 w-1/4 shadow-md transition delay-200 font-bold">Validate & Classify</button>
                </section >
